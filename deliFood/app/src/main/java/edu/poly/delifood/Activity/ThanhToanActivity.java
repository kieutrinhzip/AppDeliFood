...
public class ThanhToanActivity extends AppCompatActivity {
    ...
    private void initControll() {
        ...
        tongtien = getIntent().getLongExtra("tongtien", 1);
        ...
        if (Untils.user_current.getEmail() != null && Untils.user_current.getPass() != null) {
            ...
            txtsodt.setText(Untils.user_current.getMobile());
        }
        ...
        btndathang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(str_diachi)) {
                    ...
                    compositeDisposable.add(api.createOder(str_email, str_sdt, String.valueOf(tongtien), id, str_diachi, totalItem, new Gson().toJson(Untils.manggiohang))
                            .subscribeOn(Schedulers.io())
                            .observeOn(AndroidSchedulers.mainThread())
                            .subscribe(
                                    userModel -> {
                                        Toast.makeText(getApplicationContext(), "Thanh cong", Toast.LENGTH_SHORT).show();
                                        Untils.manggiohang.clear();
                                        Intent intent = new Intent(getApplicationContext(), MainActivity.class);
                                        startActivity(intent);
                                        finish();
                                    },
                                    throwable -> {
                                        Toast.makeText(getApplicationContext(), "khong thanh cong roi ban oi " + throwable.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                            ));
                }
            }
