...
import edu.poly.delifood.model.Item;
...
public class ChitietAdapter extends RecyclerView.Adapter<ChitietAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chitierdonhang, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.txtten.setText(item.getNewName() + "");
        holder.txtsoluong.setText("Số lượng: " + item.getSoluong() + "");
        Glide.with(context).load(item.getNewImage()).into(holder.imagechitiet);
